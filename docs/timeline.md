...
| 2026-08-24 | `df320181` | Token-efficient doc system: caveman mode, llms.txt, sub-agents. `AGENTS.md`/router + `.agents/skills/{accessibility,frontend-design}` + `.claude/agents/{fix-investigator,feature-builder,docs-keeper}`. | Humans and AI agents read the same docs; minimum tokens | ADR-0003 |
